...
class Review(models.Model):
    ...
    likes = models.ManyToManyField(User, related_name='like_reviews', blank = True, verbose_name="좋아요")
    
    title = models.CharField(max_length=128, verbose_name="제목")
    content = models.TextField(verbose_name="내용")
    image = models.ImageField(upload_to='review/', blank = True, verbose_name="이미지")
