...
router.register(r'location/(?P<location_id>[^/.]+)/reviews', views.ReviewViewSet, basename='review')
...
urlpatterns = [
    ...
    path('location/<int:location_id>/reviews/<int:review_id>/like', views.like_location_review, name='review-like'),
