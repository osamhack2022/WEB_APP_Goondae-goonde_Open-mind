      ...
      <div className='lg:navbar-start'>
        ...
        >
          <svg
            ...
            className='nline-block w-6 h-6 stroke-gray-700 dark:stroke-current'
            fill='none'
            viewBox='0 0 24 24'
            stroke='currentColor'
          >
        ...
        <ul className='menu menu-horizontal p-0'>
          ...
          <li tabIndex={0}>
            ...
            <ul className='p-2 bg-base-100'>
              <li>
                <Link to='/index'>혜택 보기</Link>
              </li>
              <li>
                <Link to='/TMOIndex'>TMO 위치</Link>
              </li>
              <li>
                <Link to='/MOUIndex'>MOU 현황</Link>
              </li>
            </ul>
          </li>
          {user ? (
